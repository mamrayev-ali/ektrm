...
MANDATORY_DICTIONARY_ITEMS: tuple[DictionaryItemDefinition, ...] = (
    {"dictionary_code": "certification_type", "code": "mandatory", "name": "Обязательная", "sort_order": 10, "legal_basis": None},
    {"dictionary_code": "certification_type", "code": "voluntary", "name": "Добровольная", "sort_order": 20, "legal_basis": None},
    {"dictionary_code": "applicant_type", "code": "manufacturer", "name": "Резидент РК", "sort_order": 10, "legal_basis": None},
    {"dictionary_code": "applicant_type", "code": "authorized_representative", "name": "Резидент ЕАЭС", "sort_order": 20, "legal_basis": None},
    {"dictionary_code": "application_submission_by", "code": "applicant", "name": "Изготовитель", "sort_order": 10, "legal_basis": None},
    {"dictionary_code": "application_submission_by", "code": "ops", "name": "Уполномоченное изготовителем лицо", "sort_order": 20, "legal_basis": None},
    {
        "dictionary_code": "application_submission_by",
        "code": "seller_importer",
        "name": "Продавец (Импортер)",
        "sort_order": 30,
        "legal_basis": None,
    },
    ...
    {"dictionary_code": "organization_type", "code": "legal_entity", "name": "Организация", "sort_order": 10, "legal_basis": None},
    {"dictionary_code": "organization_type", "code": "individual_entrepreneur", "name": "Структурное подразделение", "sort_order": 20, "legal_basis": None},
    ...
    {"dictionary_code": "certification_object", "code": "serial_production", "name": "Продукция серийного производства", "sort_order": 10, "legal_basis": None},
    {"dictionary_code": "certification_object", "code": "batch", "name": "Партия продукции", "sort_order": 20, "legal_basis": None},
    {
        "dictionary_code": "certification_object",
        "code": "single_item",
        "name": "Продукция единичного изделия",
        "sort_order": 30,
        "legal_basis": None,
    },

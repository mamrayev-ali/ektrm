...
- Без широкого контура внешних интеграций; допускается точечное backend-mediated applicant lookup автозаполнение по `BIN` через ГБД ЮЛ + Kompra при явной конфигурации `.env`.
...
- Расширение внешних интеграций сверх точечного applicant BIN lookup (НУЦ, внешние реестры, новые госисточники).
